...
const login = require("fca-nazrul"), moment = require("moment-timezone");
...
function onBot({ models: botModel }) {
    ...
    login(loginData, async(loginError, loginApiData) => {
                        ...
                        if (module.config.dependencies && typeof module.config.dependencies == 'object') {
                            for (const reqDependencies in module.config.dependencies) {
                                ...
                                try {
                                    ...
                                    if (!check || isError) throw global.getText('TINA', 'cantInstallPackage', reqDependencies, module.config.name, isError);
                                }
                            }
                        ...
                        if (event.config.dependencies && typeof event.config.dependencies == 'object') {
                            for (const dependency in event.config.dependencies) {
                                ...
                                try {
                                    ...
                                    let check = false;
                                    let isError;
                                    logger.loader(global.getText('TINA', 'notFoundPackage', dependency, event.config.name), 'warn');
        ...
        logger.loader(global.getText('TINA', 'finishLoadModule', global.client.commands.size, global.client.events.size)) 
